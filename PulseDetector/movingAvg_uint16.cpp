...
void MovingAvg_uint16::begin()
{
    m_readings = new uint16_t[m_interval];
}

// add a new reading and return the new moving average
uint16_t MovingAvg_uint16::reading(uint16_t newReading)
{
...
uint16_t MovingAvg_uint16::getAvg()
{
    return (m_sum + m_nbrReadings / 2) / m_nbrReadings;
}
...
uint16_t MovingAvg_uint16::getAvg(int nPoints)
{
